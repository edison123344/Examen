...
a persistence unit "FereteriaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Fereteria\pom.xml":
...
artifact ("Fereteria.war") is already built. You can build
