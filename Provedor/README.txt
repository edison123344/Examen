...
a persistence unit "ProvedorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Provedor\pom.xml":
...
artifact ("Provedor.war") is already built. You can build
